...
class HealthRecord(Base):
    ...
    recorded_at: Mapped[datetime] = mapped_column(DateTime, nullable=False, default=datetime.utcnow, index=True)
    record_type: Mapped[str | None] = mapped_column(String(20), nullable=True)
    ...
    exercise_details: Mapped[dict | None] = mapped_column(JSON, nullable=True)
